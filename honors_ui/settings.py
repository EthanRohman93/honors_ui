"""
Django settings for honors_ui project.
...
SECRET_KEY = 'django-insecure-)$ifvdw#0=t&w3bjtsk1w_!oud(d67i!5c$-e9zg_+k(i(0+@0'
...
WSGI_APPLICATION = 'honors_ui.wsgi.application'
